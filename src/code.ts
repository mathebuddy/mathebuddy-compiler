...
/*
 ...
 use APIS:
 - MathJS
 - TensorFlow (e.g. for eigenvalues, automatic differntiation: https://www.tensorflow.org/guide/autodiff, ...)
...
export class SellCode {
  ...
  public parse(src: string): void {
    ...
    this.lexer = new Lexer({
      ...
      multilineCommentEnd: '*/',
      parseNewlineEnabled: false, // TODO
      parseIndentationEnabled: false,
      lexerFilePositionPrefix: 'NA',
  ...
  private parseExpression(): TypedCode {
    ...
    while (this.lexer.isTER('=')) {
      ...
      } else this.lexer.errorTypes(op, x.type.base, y.type.base);
    }
    return x;
  }
